function displayTable() {
  ...
  var content = comment.map(function(item, index) {
    return '<div class="comment-result"><div class="comment-result-title"><img class="avatar" src="images/user.png"><p>Dung Nguyen:</p></div><div class="comment-result-content"><p class="comment-text">' + item + '</p><button class="btn-delete" data-id = ' + index + '>X</button></div></div>';
  });
